...
String FLName ='FN1V5 LNDHx162043'
...
'Navigate to URL Starpack Release >  http://mdb-release.diadeis.lan/MediaboxIndependence/?MBI_datasource=REL_STARPACK'
WebUI.openBrowser('')
...
'Login in gmail'
functions.I.Login_gmail('Mediabox.modif@gmail.com ', password_mediaboxCreation)


'search mail'
WebUI.setText(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="gs_lc50"]/input[1]']), 'Your login information '+ login)
...
String Actual_Errormsg1 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="toast-container"]/div/div[2]']))
...
WebUI.clearText(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="passwordConfirm"]']))
today = new Date()
String newpass = today.format("MMMddyyyy_HHmmss")
functions.I.print(newpass)
functions.I.Change_password(newpass, newpass)
...
functions.I.Logout()
functions.I.Login_password(login, newpass)
WebUI.verifyElementVisible(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="menu_2"]/a']))
