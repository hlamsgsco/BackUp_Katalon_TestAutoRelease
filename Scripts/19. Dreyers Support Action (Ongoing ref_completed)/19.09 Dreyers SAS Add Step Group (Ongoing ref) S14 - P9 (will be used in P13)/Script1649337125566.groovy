...
functions.I.clearnotepad('D:\\Upoad_File\\Projet_ Login\\Dreyers\\19.1\\19.9_Dreyers_refID9.txt')
...
def ref_name = ('P9_Auto_SAS_S14_' + org.apache.commons.lang.RandomStringUtils.randomAlphanumeric(5)) + functions.I.gettimedate()
...
'get refiD '
String refID9 = functions.I.RefID()

functions.I.print('refID' + refID9)
...
'Click on submit'
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID9) + '"]/td[14]/a[3]']))
...
String color1 = WebUI.getCSSValue(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID9) + '"]/td[14]/a[2]']), 
    'color', FailureHandling.OPTIONAL)

functions.I.print(color1)

while (color1 == 'rgba(255, 255, 255, 1)') {
    WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID9) + '"]/td[14]/a[2]']))
    ...
    color1 = WebUI.getCSSValue(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID9) + '"]/td[14]/a[2]']), 
        'color', FailureHandling.OPTIONAL)
}
...
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID9) + '"]/td[6]/a']))
...
functions.I.submitquesiton_ref(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID9) + '"]/td[14]/div[1]/button']), 
    findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID9) + '"]/td[14]/div[1]/div/a[1]']))
...
while ( i <=x)
{
	...
	String xpath_SAS ='//*[@id="source_' + refID9+ '"]/td[14]/div[1]/div/a['+i+']'
	...
	/*
////*[@id="source_3712"]/td[14]/div[1]/div/a[3]
'Choose the 3rd option- S14 - Skip 1.2 / Add Step A / Skip 1.1'
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="source_' + refID9+ '"]/td[14]/div[1]/div/a[3]']))
*/
...
//CLICK ACTION BUTTON FOR PROD
' Upload  file for Production Phase '
String color2 = WebUI.getCSSValue(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID9) + '"]/td[14]/a[2]']), 
    'color', FailureHandling.OPTIONAL)
...
while (color2 == 'rgba(255, 255, 255, 1)') {
    ...
    color2 = WebUI.getCSSValue(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID9) + '"]/td[14]/a[2]']), 
        'color', FailureHandling.OPTIONAL)
}
...
String Lifecycle_Status1 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID9) + 
            '"]/td[11]/span[1]']))
...
'Question: Submit phase'
functions.I.submitquesiton_ref(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID9) + '"]/td[13]/div[1]/button']), 
    findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID9) + '"]/td[13]/div[1]/div/a[1]']))
...
//ADDED PHASE 3.2
'Verify lifecycle status'
String Lifecycle_Status2 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID9) + 
            '"]/td[12]/span[1]']))
...
'Question: Submit phase'
functions.I.submitquesiton_ref(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID9) + '"]/td[13]/div/button']), 
    findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID9) + '"]/td[13]/div/div/a[1]']))
...
//ADDED PHASE 3.3
'Verify lifecycle status'
String Lifecycle_Status3 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID9) + 
            '"]/td[12]/span[1]']))
...
//ADDED PHASE 3.4
'Verify lifecycle status'
String Lifecycle_Status4 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID9) + 
            '"]/td[12]/span[1]']))
...
'Click on submit'
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID9) + '"]/td[13]/a[2]']))
...
//ADDED PHASE 3.5
'Verify lifecycle status'
String Lifecycle_Status5 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID9) + 
            '"]/td[12]/span[1]']))
...
//CLICK ACTION BUTTON FOR PROD
' Upload  file for Production Phase '
String color3 = WebUI.getCSSValue(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID9) + '"]/td[13]/a']), 
    'color', FailureHandling.OPTIONAL)
...
////*[@id="source_3668"]/td[13]/a[2]
'Approve a doc'
functions.I.AWF_approve_byaction(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID9) + '"]/td[13]/a[2]']))
...
functions.I.writenotepad('D:\\Upoad_File\\Projet_ Login\\Dreyers\\19.1\\19.9_Dreyers_refID9.txt', refID9)
