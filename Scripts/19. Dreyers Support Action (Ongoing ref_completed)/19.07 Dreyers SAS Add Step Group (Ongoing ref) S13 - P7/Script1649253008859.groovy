...
/* Powerpoint S13: S13: ADD STEP GROUP (contains more than one step)
Ongoing reference (last phase)


Lifecycle: Support Action P2 > Step B  > Phase 2.3
Support action :  S13  Add Step A/B- Skip to 1.1
...
Result: step group is added at the end of the lifecycle, skip works correclty OK
...
def ref_name = ('P7_Auto_SAS_S13_' + org.apache.commons.lang.RandomStringUtils.randomAlphanumeric(5)) + functions.I.gettimedate()
...
'get refiD '
String refID7 = functions.I.RefID()

'Click on save'
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="type_save"]']))

functions.I.SearchRefNo_xpath('P7_Auto', '//*[@id="fiche_filter_keywords11"]', '//*[@id="form_filters"]/div[3]/button')
...
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="source_'+refID7+'"]/td[14]/a[4]']))
...
String color1 = WebUI.getCSSValue(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID7) +
...
while (color1 == 'rgba(255, 255, 255, 1)') {
	...
	if (WebUI.verifyElementPresent(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="source_' + refID7 + '"]/td[14]/a[4]']), 5, OPTIONAL))
	{
	color1 = WebUI.getCSSValue(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="source_' + refID7 + '"]/td[14]/a[4]']),
...
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="source_' + refID7 + '"]/td[6]/a']))
...
functions.I.submitquesiton_ref(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="source_'+refID7+'"]/td[14]/div[1]/button']), findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="source_'+refID7+'"]/td[14]/div[1]/div/a[1]']))
...
//PHASE 2.3 > USE SAS 
'Click on the SAS button  S13.1[Last] : Add Step group A,B / Skip 1.1 '
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="source_'+refID7+'"]/td[14]/a[5]']))
...
'Screenshot: Turner - Ref list page'
WebUI.takeScreenshot()
...
String Lifecycle_Status2 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID7) +
			'"]/td[12]/span[1]']))
...
'Click on submit'
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID7) + '"]/td[13]/a[2]']))
