...
/* Powerpoint S15: ADD STEP GROUP(contains more than one step)
 Ongoing reference: Phase 5 (last phase) of last step
 
 Add step group: 1 step different of the current one + one step same as the current one
 
 
 Step group is added in different steps after from where the support action was executed
...
functions.I.clearnotepad('D:\\Upoad_File\\Projet_ Login\\Dreyers\\19.1\\19.10_Dreyers_refID10.txt')
...
def ref_name = ('P10_Auto_SAS_S15_' + org.apache.commons.lang.RandomStringUtils.randomAlphanumeric(5)) + functions.I.gettimedate()
...
'get refiD '
String refID10 = functions.I.RefID()
...
'Click on submit'
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="source_'+refID10+'"]/td[14]/a[3]']))
...
String color1 = WebUI.getCSSValue(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + 
            refID10) + '"]/td[14]/a[2]']), 'color', FailureHandling.OPTIONAL)
...
functions.I.submitquesiton_ref(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="source_'+refID10+'"]/td[14]/div[1]/button']), findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="source_'+refID10+'"]/td[14]/div[1]/div/a[1]']))
...
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID10) + '"]/td[14]/div[1]/button']))
...
while ( i <=x)
{
	...
	String xpath_SAS ='//*[@id="source_' + refID10 + '"]/td[14]/div[1]/div/a['+i+']'
...
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="source_' + refID10 + '"]/td[14]/div[1]/div/a[4]']))
*/
...
//CLICK ACTION BUTTON FOR PROD
' Upload  file for Production Phase '
String color2 = WebUI.getCSSValue(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID10) + 
            '"]/td[14]/a[2]']), 'color', FailureHandling.OPTIONAL)

functions.I.print(color2)

while (color2 == 'rgba(255, 255, 255, 1)') {
    WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID10) + '"]/td[14]/a[2]']))
    ...
    color2 = WebUI.getCSSValue(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID10) + '"]/td[14]/a[2]']), 
...
//ADDED PHASE 3.1
'Verify lifecycle status'
String Lifecycle_Status11 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID10) + 
            '"]/td[12]/span[1]']))

WebUI.verifyMatch(Lifecycle_Status11, 'Phase 3.1 [Question]', false)
...
'Question: Submit phase'
functions.I.submitquesiton_ref(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID10) + '"]/td[13]/div[1]/button']), 
    findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID10) + '"]/td[13]/div[1]/div/a[1]']))
...
//ADDED PHASE 3.2
'Verify lifecycle status'
String Lifecycle_Status22 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID10) + 
            '"]/td[12]/span[1]']))
...
'Question: Submit phase'
functions.I.submitquesiton_ref(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID10) + '"]/td[13]/div/button']), 
    findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID10) + '"]/td[13]/div/div/a[1]']))
...
//ADDED PHASE 3.3
'Verify lifecycle status'
String Lifecycle_Status33 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID10) + 
            '"]/td[12]/span[1]']))
...
//ADDED PHASE 3.4
'Verify lifecycle status'
String Lifecycle_Status44 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID10) + 
            '"]/td[12]/span[1]']))
...
//ADDED PHASE 3.5
'Verify lifecycle status'
String Lifecycle_Status55 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID10) + 
            '"]/td[12]/span[1]']))
...
WebUI.takeScreenshot()
functions.I.writenotepad('D:\\Upoad_File\\Projet_ Login\\Dreyers\\19.1\\19.10_Dreyers_refID10.txt', refID10)
