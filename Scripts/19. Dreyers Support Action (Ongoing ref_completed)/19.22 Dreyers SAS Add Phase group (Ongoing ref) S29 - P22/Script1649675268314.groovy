...
/* Powerpoint S29: ADD PHASE GROUP
 ...
 Result: phase group is added inside the current step and skip works
 
 SAS : SS29: Add Step C / Skip P3.1
  */
...
def ref_name = ('P22_Auto_SAS_S29_' + org.apache.commons.lang.RandomStringUtils.randomAlphanumeric(5)) + functions.I.gettimedate()
...
'get refiD '
String refID22 = functions.I.RefID()
...
functions.I.SearchRefNo_xpath('P22_Auto', '//*[@id="fiche_filter_keywords11"]', '//*[@id="form_filters"]/div[3]/button')

'Click on submit'
////*[@id="source_3667"]/td[14]/a[3]
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="source_'+refID22+'"]/td[14]/a[3]']))
...
String color1 = WebUI.getCSSValue(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + 
            refID22) + '"]/td[14]/a[2]']), 'color', FailureHandling.OPTIONAL)
...
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="source_'+refID22+'"]/td[6]/a']))
...
functions.I.submitquesiton_ref(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="source_'+refID22+'"]/td[14]/div[1]/button']), findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="source_'+refID22+'"]/td[14]/div[1]/div/a[1]']))
...
String StepCP5_0 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : '/html/body/div[1]/div[2]/div[8]/div[3]/div/div[3]/div[3]/div/div/div[3]/div/div[6]/div/div[1]/div[1]/h3']))

WebUI.verifyMatch(StepCP5_0, 'Phase 3.1 [Question]', false)

String Started_StepCP5_1 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : '/html/body/div[1]/div[2]/div[8]/div[3]/div/div[3]/div[3]/div/div/div[3]/div/div[6]/div/div[2]/div[1]']))
...
WebUI.verifyElementNotPresent(findTestObject('1. Constant/xpath', [('xpath') : '/html/body/div[1]/div[2]/div[8]/div[3]/div/div[3]/div[3]/div/div/div[3]/div/div[11]/div/div[1]']), 
    10)
...
String Lifecycle_Status1 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID22) + 
            '"]/td[11]/span[1]']))
...
'Question: Submit phase'
functions.I.submitquesiton_ref(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID22) + '"]/td[13]/div[1]/button']), 
    findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID22) + '"]/td[13]/div[1]/div/a[1]']))
...
//ADDED PHASE 3.2
'Verify lifecycle status'
String Lifecycle_Status2 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID22) + 
            '"]/td[12]/span[1]']))
...
'Question: Submit phase'
functions.I.submitquesiton_ref(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID22) + '"]/td[13]/div/button']), 
    findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID22) + '"]/td[13]/div/div/a[1]']))
...
//ADDED PHASE 3.3
'Verify lifecycle status'
String Lifecycle_Status3 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID22) + 
            '"]/td[12]/span[1]']))
...
'Click on submit'
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID22) + '"]/td[14]/a[2]']))
...
//ADDED PHASE 3.4
'Verify lifecycle status'
String Lifecycle_Status4 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID22) + 
            '"]/td[12]/span[1]']))
...
'Click on submit'
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID22) + '"]/td[13]/a[2]']))
...
//ADDED PHASE 3.5
'Verify lifecycle status'
String Lifecycle_Status5 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID22) + 
            '"]/td[12]/span[1]']))
...
//CLICK ACTION BUTTON FOR PROD
' Upload  file for Production Phase '
String color3 = WebUI.getCSSValue(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID22) + 
            '"]/td[13]/a']), 'color', FailureHandling.OPTIONAL)

while (color3 == 'rgba(255, 255, 255, 1)') {
    WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID22) + '"]/td[13]/a']))
    ...
    color3 = WebUI.getCSSValue(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID22) + '"]/td[13]/a']), 
...
'Approve a doc'
functions.I.AWF_approve_byaction(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID22) + 
            '"]/td[13]/a[2]']))

WebUI.delay(2)

'Verify lifecycle status'
String Lifecycle_Status6 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID22) + 
            '"]/td[12]/span[1]']))
