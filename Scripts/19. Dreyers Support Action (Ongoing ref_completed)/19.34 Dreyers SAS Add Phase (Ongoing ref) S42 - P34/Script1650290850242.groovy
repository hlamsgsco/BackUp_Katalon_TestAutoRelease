...
/* Powerpoint:S42 ADD PHASE
 Ongoing reference: no last phase of last Step
 Skip to the next phase
 Add a phase belonging to the same step
 Skip a phase inside the step
 Results:  first skip ok, the new phase is added correctly inside the current step after the phase where the first skip stopped, skip works correctly
...
def ref_name = ('P34_Auto_SAS_S42_' + org.apache.commons.lang.RandomStringUtils.randomAlphanumeric(5)) + functions.I.gettimedate()
...
'get refiD '
String refID34 = functions.I.RefID()

functions.I.print('refID' + refID34)
...
functions.I.SearchRefNo_xpath('P34_Auto', '//*[@id="fiche_filter_keywords11"]', '//*[@id="form_filters"]/div[3]/button')

'Click on submit'
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID34) + '"]/td[14]/a[3]']))
...
String color1 = WebUI.getCSSValue(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID34) + '"]/td[14]/a[2]']), 
    'color', FailureHandling.OPTIONAL)

functions.I.print(color1)

while (color1 == 'rgba(255, 255, 255, 1)') {
    WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID34) + '"]/td[14]/a[2]']))
    ...
    color1 = WebUI.getCSSValue(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID34) + '"]/td[14]/a[2]']), 
        'color', FailureHandling.OPTIONAL)
}
...
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID34) + '"]/td[6]/a']))
...
functions.I.submitquesiton_ref(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID34) + '"]/td[14]/div[1]/button']), 
    findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID34) + '"]/td[14]/div[1]/div/a[1]']))
...
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : '/html/body/div[1]/div[2]/div[8]/div[3]/div/div[3]/div[3]/div/div/div[3]/div/div[3]/div/div[1]/div[2]/div/a[4]']))
...
String Started_StepCP35_1 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : '/html/body/div[1]/div[2]/div[8]/div[3]/div/div[3]/div[3]/div/div/div[3]/div/div[5]/div/div[2]/div[1]']))

if (Started_StepCP35_1.contains('Started')) {
    WebUI.verifyEqual(1, 1)
} else {
    WebUI.verifyEqual(1, 2)
}

String Added_StepCP35_1 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : '/html/body/div[1]/div[2]/div[8]/div[3]/div/div[3]/div[3]/div/div/div[3]/div/div[5]/div/div[2]/h6']))

if (Added_StepCP35_1.contains('Added manually')) {
    WebUI.verifyEqual(1, 1)
} else {
    WebUI.verifyEqual(1, 2)
}
...
//Phase 3.5
String Name_Phase35_1 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : '/html/body/div[1]/div[2]/div[8]/div[3]/div/div[3]/div[3]/div/div/div[3]/div/div[6]/div/div[1]/div[1]/h3']))

WebUI.verifyMatch(Name_Phase35_1, 'Phase 3.5[Prod]', false)
...
////*[@id="source_3672"]/td[11]/span[1]
'Verify lifecycle status'
String Lifecycle_Status1 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID34) + 
            '"]/td[11]/span[1]']))

WebUI.verifyMatch(Lifecycle_Status1, 'Phase 3.5[Prod]', false)
...
//CLICK ACTION BUTTON FOR PROD
' Upload  file for Production Phase '
String color2 = WebUI.getCSSValue(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID34) + '"]/td[13]/a']), 
    'color', FailureHandling.OPTIONAL)

while (color2 == 'rgba(255, 255, 255, 1)') {
    WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID34) + '"]/td[13]/a']))
    ...
    color2 = WebUI.getCSSValue(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID34) + '"]/td[13]/a']), 
        'color', FailureHandling.OPTIONAL)
}
...
'Approve a doc'
functions.I.AWF_approve_byaction(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID34) + '"]/td[13]/a[2]']))

//ADDED PHASE 3.5
'Verify lifecycle status'
String Lifecycle_Status7 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID34) + 
            '"]/td[12]/span[1]']))
...
//CLICK ACTION BUTTON FOR PROD
' Upload  file for Production Phase '
String color3 = WebUI.getCSSValue(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID34) + '"]/td[13]/a']), 
    'color', FailureHandling.OPTIONAL)
...
while (color3 == 'rgba(255, 255, 255, 1)') {
    ...
    color3 = WebUI.getCSSValue(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID34) + '"]/td[13]/a']), 
        'color', FailureHandling.OPTIONAL)
}
...
'Verify lifecycle status'
String Lifecycle_Status8 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID34) + 
            '"]/td[12]/span[1]']))
