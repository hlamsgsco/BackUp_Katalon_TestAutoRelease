...
/*  Powerpoint S27: ADD PHASE GROUP
 ...
 Result: phase group is added inside the current step after the phase from where I launched the SAS and skip works
 
 Support action : SAS S27: Add PG Step C/ Skip P3.1
  */
...
def ref_name = ('P21_Auto_SAS_S27_' + org.apache.commons.lang.RandomStringUtils.randomAlphanumeric(5)) + functions.I.gettimedate()
...
'get refiD '
String refID21 = functions.I.RefID()
...
functions.I.SearchRefNo_xpath('P21_Auto', '//*[@id="fiche_filter_keywords11"]', '//*[@id="form_filters"]/div[3]/button')

'Click on submit'
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID21) + '"]/td[14]/a[3]']))
...
String color1 = WebUI.getCSSValue(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID21) + '"]/td[14]/a[2]']), 
    'color', FailureHandling.OPTIONAL)

while (color1 == 'rgba(255, 255, 255, 1)') {
    WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID21) + '"]/td[14]/a[2]']))
    ...
    color1 = WebUI.getCSSValue(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID21) + '"]/td[14]/a[2]']), 
        'color', FailureHandling.OPTIONAL)
}
...
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID21) + '"]/td[6]/a']))
...
functions.I.submitquesiton_ref(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID21) + '"]/td[14]/div[1]/button']), 
    findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID21) + '"]/td[14]/div[1]/div/a[1]']))
...
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID21) + '"]/td[14]/div[1]/button']))
...
while ( i <=x)
{
	String Expected_SAS_Selected = 'SAS S27: Add PG Step C/ Skip P3.1'

	String xpath_SAS ='//*[@id="source_' + refID21 + '"]/td[14]/div[1]/div/a['+i+']'
...
/*
'Choose the 4th option-   S27'
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="source_' + refID21 + '"]/td[14]/div[1]/div/a[4]']))
*/
...
String StepCP4_1 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : '/html/body/div[1]/div[2]/div[8]/div[3]/div/div[3]/div[3]/div/div/div[3]/div/div[5]/div/div[1]/div[1]/h3']))

WebUI.verifyMatch(StepCP4_1, 'Phase 3.1 [Question]', false)

String Started_StepCP4_1 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : '/html/body/div[1]/div[2]/div[8]/div[3]/div/div[3]/div[3]/div/div/div[3]/div/div[5]/div/div[2]/div[1]']))
...
//PHASE 3.5 
String StepCP4_2 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : '/html/body/div[1]/div[2]/div[8]/div[3]/div/div[3]/div[3]/div/div/div[3]/div/div[9]/div/div[1]/div[1]/h3']))

WebUI.verifyMatch(StepCP4_2, 'Phase 3.5[Prod]', false)

//PHASE 3.5
String StepCP4_3 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : '/html/body/div[1]/div[2]/div[8]/div[3]/div/div[3]/div[3]/div/div/div[3]/div/div[10]/div/div[1]/div[1]/h3']))

WebUI.verifyMatch(StepCP4_3, 'Phase 3.5[Prod]', false)

//VERIFY THAT THERE IS NO PHASE AFTER
'Verify that there is no phase after 3.5'
WebUI.verifyElementNotPresent(findTestObject('1. Constant/xpath', [('xpath') : '/html/body/div[1]/div[2]/div[8]/div[3]/div/div[3]/div[3]/div/div/div[3]/div/div[11]/div/div[1]/div[1]/h3']), 
    10)
...
'Question: Submit phase'
functions.I.submitquesiton_ref(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID21) + '"]/td[13]/div[1]/button']), 
    findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID21) + '"]/td[13]/div[1]/div/a[1]']))
...
String Lifecycle_Status22 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID21) + 
            '"]/td[12]/span[1]']))
...
'Question: Submit phase'
functions.I.submitquesiton_ref(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID21) + '"]/td[13]/div/button']), 
    findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID21) + '"]/td[13]/div/div/a[1]']))
...
//ADDED PHASE 3.3
'Verify lifecycle status'
String Lifecycle_Status33 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID21) + 
            '"]/td[12]/span[1]']))
...
//ADDED PHASE 3.4
'Verify lifecycle status'
String Lifecycle_Status44 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID21) + 
            '"]/td[12]/span[1]']))
...
'Click on submit'
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID21) + '"]/td[13]/a[2]']))
...
//ADDED PHASE 3.5
'Verify lifecycle status'
String Lifecycle_Status55 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID21) + 
            '"]/td[12]/span[1]']))
...
'Screenshot: lamary Ref Lista page'
WebUI.takeScreenshot()

//CLICK ACTION BUTTON FOR PROD
' Upload  file for Production Phase '
String color3 = WebUI.getCSSValue(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID21) + '"]/td[13]/a']), 
    'color', FailureHandling.OPTIONAL)

while (color3 == 'rgba(255, 255, 255, 1)') {
    WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID21) + '"]/td[13]/a']))
    ...
    color3 = WebUI.getCSSValue(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID21) + '"]/td[13]/a']), 
        'color', FailureHandling.OPTIONAL)
}
...
'144 Approve a doc'
functions.I.AWF_approve_byaction(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="source_' + refID21 + '"]/td[13]/a[2]']))

'Verify lifecycle status'
String Lifecycle_Status66 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="source_' + refID21+ 
            '"]/td[12]/span[1]']))

WebUI.verifyMatch(Lifecycle_Status66, 'Phase 3.5[Prod]', false)
...
//CLICK ACTION BUTTON FOR PROD
' Upload  file for Production Phase '
String color4 = WebUI.getCSSValue(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID21) + '"]/td[13]/a']), 
    'color', FailureHandling.OPTIONAL)
...
while (color4 == 'rgba(255, 255, 255, 1)') {
    ...
    color4 = WebUI.getCSSValue(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID21) + '"]/td[13]/a']), 
        'color', FailureHandling.OPTIONAL)
}
...
'Verify lifecycle status'
String Lifecycle_Status77 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID21) + 
            '"]/td[12]/span[1]']))

WebUI.verifyMatch(Lifecycle_Status77, 'Complete', false)
