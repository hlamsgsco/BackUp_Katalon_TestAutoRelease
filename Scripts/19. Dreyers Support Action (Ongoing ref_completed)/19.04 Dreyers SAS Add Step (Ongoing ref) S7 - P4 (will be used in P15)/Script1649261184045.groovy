...
/* Powerpoint S7: ADD STEP (contains one step)
 Ongoing reference: Phase 4 (no last phase) of the last step
...
functions.I.clearnotepad('D:\\Upoad_File\\Projet_ Login\\Dreyers\\19.1\\19.4_Dreyers_refID4.txt')
...
def ref_name = ('P4_Auto_SAS_S7_' + org.apache.commons.lang.RandomStringUtils.randomAlphanumeric(5)) + functions.I.gettimedate()
...
'Click on submit'
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID4) + '"]/td[14]/a[3]']))
...
String color1 = WebUI.getCSSValue(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID4) + '"]/td[14]/a[2]']), 
    'color', FailureHandling.OPTIONAL)

functions.I.print(color1)

while (color1 == 'rgba(255, 255, 255, 1)') {
    WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID4) + '"]/td[14]/a[2]']))
    ...
    color1 = WebUI.getCSSValue(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID4) + '"]/td[14]/a[2]']), 
        'color', FailureHandling.OPTIONAL)
}
...
functions.I.submitquesiton_ref(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID4) + '"]/td[14]/div[1]/button']), 
    findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID4) + '"]/td[14]/div[1]/div/a[1]']))
...
while ( i <=x)
{
	String Expected_SAS_Selected = 'SAS: S6 - Add Steps C'
...
/*'Choose the 1st option- S6 - Step C'
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : '/html/body/div[1]/div[2]/div[8]/div[3]/div/div[3]/div[3]/div/div/div[3]/div/div[4]/div/div[1]/div[2]/div/div/a[1]']))
*/
...
String Lifecycle_Status1 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID4) + 
            '"]/td[11]/span[1]']))
...
//CLICK ACTION BUTTON FOR PROD
' Upload  file for Production Phase '
String color2 = WebUI.getCSSValue(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID4) + '"]/td[13]/a']), 
    'color', FailureHandling.OPTIONAL)

while (color2 == 'rgba(255, 255, 255, 1)') {
    WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID4) + '"]/td[13]/a']))
    ...
    color2 = WebUI.getCSSValue(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID4) + '"]/td[13]/a']), 
        'color', FailureHandling.OPTIONAL)
}
...
'Approve a doc'
functions.I.AWF_approve_byaction(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID4) + '"]/td[13]/a[2]']))
...
WebUI.verifyMatch(Lifecycle_Status3, 'Phase 3.1 [Question]', false)
...
WebUI.verifyMatch(Lifecycle_Status4, 'Phase 3.2 [Question]', false)
...
'Question: Submit phase'
functions.I.submitquesiton_ref(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID4) + '"]/td[13]/div/button']), 
    findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID4) + '"]/td[13]/div/div/a[1]']))
...
//ADDED PHASE 3.3
'Verify lifecycle status'
String Lifecycle_Status5 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID4) + 
            '"]/td[12]/span[1]']))

WebUI.verifyMatch(Lifecycle_Status5, 'Phase 3.3 [Standard]', false)
...
//ADDED PHASE 3.4
'Verify lifecycle status'
String Lifecycle_Status6 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID4) + 
            '"]/td[12]/span[1]']))

WebUI.verifyMatch(Lifecycle_Status6, 'Phase 3.4 [Standard]', false)
...
//ADDED PHASE 3.5
'Verify lifecycle status'
String Lifecycle_Status7 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID4) + 
            '"]/td[12]/span[1]']))
...
//CLICK ACTION BUTTON FOR PROD
' Upload  file for Production Phase '
String color3 = WebUI.getCSSValue(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID4) + '"]/td[13]/a']), 
    'color', FailureHandling.OPTIONAL)
...
while (color3 == 'rgba(255, 255, 255, 1)') {
    ...
    color3 = WebUI.getCSSValue(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID4) + '"]/td[13]/a']), 
        'color', FailureHandling.OPTIONAL)
}
...
'Verify lifecycle status'
String Lifecycle_Status8 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID4) + 
            '"]/td[12]/span[1]']))
...
functions.I.writenotepad('D:\\Upoad_File\\Projet_ Login\\Dreyers\\19.1\\19.4_Dreyers_refID4.txt', refID4)
