...
'Choose option 1st : S5 - Add Step A - Skip Phase 1.1'
...
String Lifecycle_Status = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="source_'+refID2+'"]/td[12]/span[1]']))
