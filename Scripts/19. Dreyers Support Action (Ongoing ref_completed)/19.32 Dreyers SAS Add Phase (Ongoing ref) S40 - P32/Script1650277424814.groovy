...
/* S40: ADD PHASE
 ...
 Support action :  S40: Add Phase 3.3/ Skip Phase 1.2
    */
...
def ref_name = ('P32_Auto_SAS_S39_' + org.apache.commons.lang.RandomStringUtils.randomAlphanumeric(5)) + functions.I.gettimedate()
...
'get refiD '
String refID32 = functions.I.RefID()

functions.I.print('refID' + refID32)
...
functions.I.SearchRefNo_xpath('P32_Auto', '//*[@id="fiche_filter_keywords11"]', '//*[@id="form_filters"]/div[3]/button')

////*[@id="source_3665"]/td[13]/a[3]
'Click on submit'
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID32) + '"]/td[13]/a[3]']))
...
'Click on SAS buton'
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="source_'+refID32+'"]/td[13]/div[1]/button']))
...
while ( i <=x)
{
	String Expected_SAS_Selected = '3. SAS S40: Add Phase 3.3/ Skip Phase 1.2'
	
	String xpath_SAS ='//*[@id="source_'+refID32+'"]/td[13]/div[1]/div/a['+i+']'
...
/*
'Choose option 1st :SAS 40'
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="source_'+refID32+'"]/td[13]/div[1]/div/a[1]']))
*/
...
String Lifecycle_Status1 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID32) + 
            '"]/td[12]/span[1]']))

WebUI.verifyMatch(Lifecycle_Status1, 'Phase 1.2 [Standard Phase]', false)

'click on Submit'
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID32) + '"]/td[13]/a[2]']))
...
//ADDED PHASE 3.3
'Verify lifecycle status'
String Lifecycle_Status4 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID32) + 
            '"]/td[12]/span[1]']))
...
'Click on submit'
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID32) + '"]/td[14]/a[2]']))
...
'Verify lifecycle status'
String Lifecycle_Status8 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID32) + 
            '"]/td[12]/span[1]']))
...
String color2 = WebUI.getCSSValue(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' +
			refID32) + '"]/td[14]/a[2]']), 'color', FailureHandling.OPTIONAL)
...
while (color2 == 'rgba(255, 255, 255, 1)') {
	...
	color2 = WebUI.getCSSValue(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' +
				refID32) + '"]/td[14]/a[2]']), 'color', FailureHandling.OPTIONAL)
}
...
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="source_'+refID32+'"]/td[6]/a']))
...
'Verify lifecycle status'
String Lifecycle_Status9 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="source_' + refID32 +	'"]/td[11]/span[1]']))
