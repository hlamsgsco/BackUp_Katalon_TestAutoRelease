...
/* Powerpoint S31: ADD PHASE GROUP
 ...
 Result: skip to next phase, phase group is added in a new step and skip works
 
 SAS : S31: Skip Phase 3.5/Add Phase Group SA/ Skip to Phase 1.1
...
def ref_name = ('P24_Auto_SAS_S31_' + org.apache.commons.lang.RandomStringUtils.randomAlphanumeric(5)) + functions.I.gettimedate()
...
'get refiD '
String refID24 = functions.I.RefID()
...
functions.I.SearchRefNo_xpath('P24_Auto', '//*[@id="fiche_filter_keywords11"]', '//*[@id="form_filters"]/div[3]/button')

'Click on submit'
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="source_'+refID24+'"]/td[14]/a[3]']))
...
String color1 = WebUI.getCSSValue(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + 
            refID24) + '"]/td[14]/a[2]']), 'color', FailureHandling.OPTIONAL)
...
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="source_'+refID24+'"]/td[6]/a']))
...
////*[@id="level_apl_0"]/div[2]/div[2]/div/div/div[6]/a[2]/span
WebUI.delay(1)
...
functions.I.submitquesiton_ref(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="source_'+refID24+'"]/td[14]/div[1]/button']), findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="source_'+refID24+'"]/td[14]/div[1]/div/a[1]']))
...
'Click on the SAS'
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID24) + '"]/td[14]/div[1]/button']))
...
String Lifecycle_Status1 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID24) + 
            '"]/td[11]/span[1]']))
...
'Click on submit'
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="source_' + refID24 + '"]/td[13]/a[3]']))
...
'Verify lifecycle status'
String Lifecycle_Status3 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID24) + 
            '"]/td[12]/span[1]']))
...
'click on Submit'
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID24) + '"]/td[13]/a[2]']))

'Click on submit'
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="ModifFiche"]/div[1]/div/button[2]']))

'Verify lifecycle status'
String Lifecycle_Status11 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID24) + 
            '"]/td[12]/span']))
