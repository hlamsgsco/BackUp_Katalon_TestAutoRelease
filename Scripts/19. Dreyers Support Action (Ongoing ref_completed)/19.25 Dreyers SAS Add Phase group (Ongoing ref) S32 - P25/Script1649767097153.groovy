...
/* Powerpoint S32: ADD PHASE GROUP
 ...
 Result: phase group is added in the current step and skip works
...
def ref_name = ('P25_Auto_SAS_S32_' + org.apache.commons.lang.RandomStringUtils.randomAlphanumeric(5)) + functions.I.gettimedate()
...
'get refiD '
String refID25 = functions.I.RefID()
...
functions.I.SearchRefNo_xpath('P25_Auto', '//*[@id="fiche_filter_keywords11"]', '//*[@id="form_filters"]/div[3]/button')

'Click on submit'
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="source_'+refID25+'"]/td[14]/a[3]']))
...
String color1 = WebUI.getCSSValue(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + 
            refID25) + '"]/td[14]/a[2]']), 'color', FailureHandling.OPTIONAL)
...
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="source_'+refID25+'"]/td[6]/a']))
...
functions.I.submitquesiton_ref(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="source_'+refID25+'"]/td[14]/div[1]/button']), findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="source_'+refID25+'"]/td[14]/div[1]/div/a[1]']))
...
'Click on the SAS'
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="source_'+refID25+'"]/td[14]/div[1]/button']))
...
while ( i <=x)
{
	...
	String xpath_SAS ='//*[@id="source_'+refID25+'"]/td[14]/div[1]/div/a['+i+']'
...
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="source_'+refID25+'"]/td[14]/div[1]/div/a[8]']))
*/
...
String Lifecycle_Status1 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID25) + 
            '"]/td[11]/span[1]']))
...
'Click on submit'
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID25) + '"]/td[13]/a[3]']))
...
'Verify lifecycle status'
String Lifecycle_Status3 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID25) + 
            '"]/td[12]/span[1]']))
...
'click on Submit'
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID25) + '"]/td[13]/a[2]']))

'Click on submit'
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="ModifFiche"]/div[1]/div/button[2]']))

'Verify lifecycle status'
String Lifecycle_Status11 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + refID25) + 
            '"]/td[12]/span[1]']))
