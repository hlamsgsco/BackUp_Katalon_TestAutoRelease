...
'SCENARIO 1 : ALL REQUIRED FIELDS ARE EMPTY'
    ...
    'Screenshot: Scenario1 > Toastr is displayed '
...
'SCENARIO 3: Last Name blank'
    ...
    WebUI.clearText(findTestObject('1. Constant/01_id_field_id', 
            [('field_id') : 'userName']), FailureHandling.STOP_ON_FAILURE)
...
'SCENARIO 4: First name blank'
    ...
    //First name //*[@id="userFirstName"]
    'Clear Text: First name'
    WebUI.clearText(findTestObject('1. Constant/01_id_field_id', 
            [('field_id') : 'userFirstName']), FailureHandling.STOP_ON_FAILURE)
...
'SCENARIO 5A: Login blank'
    ...
    ////*[@id="userLogin"]
    WebUI.clearText(findTestObject('1. Constant/01_id_field_id', 
            [('field_id') : 'userLogin']), FailureHandling.STOP_ON_FAILURE)
...
'SCENARIO 5B: Login with 3 characters'
    ...
    //Insert Login
    WebUI.setText(findTestObject('1. Constant/01_id_field_id', [('field_id') : 'userLogin']), 
        'ter')
