...
String Project_No = functions.I.readnotepad('D:\\Upoad_File\\Projet_ Login\\Sephora\\3.01\\3.01_Sephora_ProjectNo.txt')

String refID = functions.I.readnotepad('D:\\Upoad_File\\Projet_ Login\\Sephora\\3.01\\3.01_Sephora_refID.txt')

//Scenario 1 : Flashback sur une ref complete
//PART A: Add a phase 
//[Phase de la même lifecycle et même step] - Question phase
//[Phase de la même lifecycle et different step] - Production phase
//[Phase de la different lifecycle et different step] - Standard  phase
///////////////////////////////////////TEST START ///////////////////////////////////////
...
// log in as MArketing to verify task
'Login as marketing'
...
'43 Verify that no step is created'
