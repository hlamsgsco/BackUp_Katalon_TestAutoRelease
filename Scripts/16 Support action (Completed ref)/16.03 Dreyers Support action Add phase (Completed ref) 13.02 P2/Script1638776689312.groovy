...
//READ FROM NOTEPAD
String Project_No = functions.I.readnotepad('D:\\Upoad_File\\Projet_ Login\\Dreyers\\13.2\\13.2_Dreyers_ProjectNo.txt')

String refID = functions.I.readnotepad('D:\\Upoad_File\\Projet_ Login\\Dreyers\\13.2\\13.2_Dreyers_refID_Design(M).txt')

String refID_daughter1 = functions.I.readnotepad('D:\\Upoad_File\\Projet_ Login\\Dreyers\\13.2\\13.2_Dreyers_refID_Deliverable(D).txt')

String refID_APL = functions.I.readnotepad('D:\\Upoad_File\\Projet_ Login\\Dreyers\\13.2\\13.2_Dreyers_refID_APL(GD).txt')

String refID_LI = functions.I.readnotepad('D:\\Upoad_File\\Projet_ Login\\Dreyers\\13.2\\13.2_Dreyers_refID_LI(GD).txt')
...
'28 Verify if the button support action is displayed'
...
'34 Screenshot: Login as bmilhomme'
WebUI.takeScreenshot()
...
///html/body/div[1]/div[2]/div[8]/div[3]/div/div[3]/div[3]/div/div/div[2]/div/div/div/div[1]/div[2]/div/button
///html/body/div[1]/div[2]/div[8]/div[3]/div/div[3]/div[3]/div/div/div[2]/div/div[4]/div/div[1]/div[2]/div/button
'43 Click SAS'
