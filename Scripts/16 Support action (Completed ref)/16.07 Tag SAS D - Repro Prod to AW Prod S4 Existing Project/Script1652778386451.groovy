...
////////////////////SCENARIO 1 :
/*
Sceanrio 4: D - Repro Prod to AW Prod
...
'Clcik on ref link 24386 '
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="source_24386"]/td[8]/a']))
...
while ( i <=x)
{
	String Expected_SAS_Selected = 'Go back to Artwork production'
					   ///html/body/div[1]/div[2]/div[8]/div[3]/div/div[3]/div[3]/div/div/div[2]/div/div[2]/div/div[1]/div[2]/div/div/a[1]
	String xpath_SAS ='/html/body/div[1]/div[2]/div[8]/div[3]/div/div[3]/div[3]/div/div/div[2]/div/div[2]/div/div[1]/div[2]/div/div/a['+i+']'
...
'status lifecycel'
String status1 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="source_24386"]/td[13]/span[1]']))

WebUI.verifyMatch(status1, 'Agency: Artwork production', false)
