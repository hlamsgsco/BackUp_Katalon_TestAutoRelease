...
//READ FROM NOTEPAD
String Project_No = functions.I.readnotepad('D:\\Upoad_File\\Projet_ Login\\Dreyers\\13.1\\13.1_Dreyers_ProjectNo.txt')

String refID = functions.I.readnotepad('D:\\Upoad_File\\Projet_ Login\\Dreyers\\13.1\\13.1_Dreyers_refID_Design(M).txt')

String refID_daughter1 = functions.I.readnotepad('D:\\Upoad_File\\Projet_ Login\\Dreyers\\13.1\\13.1_Dreyers_refID_Deliverable(D).txt')

String refID_APL = functions.I.readnotepad('D:\\Upoad_File\\Projet_ Login\\Dreyers\\13.1\\13.1_Dreyers_refID_APL(GD).txt')

String refID_LI = functions.I.readnotepad('D:\\Upoad_File\\Projet_ Login\\Dreyers\\13.1\\13.1_Dreyers_refID_LI(GD).txt')
...
'42 Verify if the button support action is displayed'
