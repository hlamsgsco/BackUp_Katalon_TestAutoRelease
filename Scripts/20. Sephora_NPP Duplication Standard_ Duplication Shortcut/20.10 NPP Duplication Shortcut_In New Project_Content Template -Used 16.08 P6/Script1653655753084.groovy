...
functions.I.clearnotepad('D:\\Upoad_File\\Projet_ Login\\NPP\\16.08\\20.10_NPP_ProjectNo.txt')
...
def LSSNumber_name = (('TC20.10_AutoTest_Npp_Duplication_NewProj_' + org.apache.commons.lang.RandomStringUtils.randomAlphanumeric(
...
//CLOSE PROJECT
'cancel ref'
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="fiches"]/table/tbody/tr/td[9]/div[2]/button']))

WebUI.delay(2)
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="fiches"]/table/tbody/tr/td[9]/div[2]/div/a[2]']))
