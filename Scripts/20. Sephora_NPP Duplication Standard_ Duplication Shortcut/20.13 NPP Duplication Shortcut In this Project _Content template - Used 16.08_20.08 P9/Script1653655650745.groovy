...
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="modal_duplicate_reference"]/div/div/div[2]/div/div[8]/div[1]/label[2]']))

'Verify the text of the Window HELPER TEXT is: New LSS version'
functions.I.VerifyMatchText('//*[@id="info_translation_block"]', 'This option will duplicate the values from the brief and the source text structure (blocks to translate). The source content and the translations will not be collected.')
...
//REF LIST PAGE
'Verify that the no of ref is 3'
functions.I.VerifyMatchText('//*[@id="kt_content"]/div[3]/div/div[2]/div[1]/div[1]/h1/span', '3')

'Click on reflink'
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="fiches"]/table/tbody/tr[3]/td[5]/a']))
...
functions.I.Verify_Table_getdata('//*[@id="table_body"]', 0, 15, ExpectedValue1)

'Verify Translated reference '
functions.I.Verify_Table_getdata('//*[@id="table_body"]', 0, 16, ExpectedValue2)
...
'Enter Variety'
WebUI.setText(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="var_110"]']), 'TC20.13 Super edit Variety')
...
WebUI.verifyMatch(Actual_Edited_Variety,'TC20.13 Super edit Variety', false)
