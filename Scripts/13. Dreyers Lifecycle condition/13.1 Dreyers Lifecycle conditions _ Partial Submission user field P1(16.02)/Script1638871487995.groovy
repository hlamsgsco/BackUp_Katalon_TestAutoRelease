...
// NOTEPAD CLEAR
functions.I.clearnotepad('D:\\Upoad_File\\Projet_ Login\\Dreyers\\13.1\\13.1_Dreyers_ProjectNo.txt')
functions.I.clearnotepad('D:\\Upoad_File\\Projet_ Login\\Dreyers\\13.1\\13.1_Dreyers_refID_Deliverable(D).txt')
functions.I.clearnotepad('D:\\Upoad_File\\Projet_ Login\\Dreyers\\13.1\\13.1_Dreyers_refID_Design(M).txt')
functions.I.clearnotepad('D:\\Upoad_File\\Projet_ Login\\Dreyers\\13.1\\13.1_Dreyers_refID_APL(GD).txt')
functions.I.clearnotepad('D:\\Upoad_File\\Projet_ Login\\Dreyers\\13.1\\13.1_Dreyers_refID_LI(GD).txt')
...
def project_name = (('Auto_LifecycleCondition_' + org.apache.commons.lang.RandomStringUtils.randomAlphanumeric(3)) + '_') + 
...
String lifecyclestatus1 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + 
            refID) + '"]/td[12]/span']))
...
'68 Enter text: Deliverable name'
...
'Package Type: Club'
WebUI.selectOptionByValue(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="var_106"]']), 
    '145', false)
...
String lifecyclestatus2 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + 
            refID_daughter1) + '"]/td[16]/span[1]']))
...
WebUI.click(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="ancre_' + 
            refID_APL) + '"]/a']))
...
String lifecyclestatus3 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + 
            refID_daughter1) + '"]/td[16]/span[1]']))
...
////////////////////////GRAND DAUGHTER ///////////////////////////////
/////////////////////////PARTIAL SUBMISSION 1/3 - ANA ////////////////////////
'Login as ana massoth'
...
String lifecyclestatus4 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + 
            refID) + '"]/td[16]/span[1]']))

'95 verify match\r\n'
WebUI.verifyMatch(lifecyclestatus4, 'Complete', false)

//*[@id="source_2256"]/td[16]/span[1]
'Verify the lifecycle of granddaughter ref'
String lifecyclestatus5 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + 
            refID_LI) + '"]/td[16]/span[1]']))

WebUI.verifyMatch(lifecyclestatus5, 'Information  Input', false)

functions.I.Logout()

/////////////////////////PARTIAL SUBMISSION 2/3 -  bharandi ////////////////////////
'Login as Tech: Bob Harandi > bharandi'
...
'Verify the lifecycle of daughter ref'
String lifecyclestatus9 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + 
            refID_daughter1) + '"]/td[16]/span[1]']))


WebUI.verifyMatch(lifecyclestatus9, 'Waiting for APL and LI', false)


'Verify the lifecycle of granddaughter ref'
String lifecyclestatus6 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + 
            refID_LI) + '"]/td[16]/span[1]']))

WebUI.verifyMatch(lifecyclestatus6, 'Information  Input', false)
...
'toastr: The condition Label Information Complete is not matched'
String toastr2 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : '//*[@id="toast-container"]/div/div[2]']))

WebUI.verifyMatch(toastr2, 'The condition \'Label Information Complete\' is not matched', false)

functions.I.print(toastr2)
...
/////////////////////////PARTIAL SUBMISSION 3/3 -  mbaughman ////////////////////////
'120 Login as Marketing: Margaret Baughman > mbaughman'
...
//*[@id="source_2255"]/td[15]/span[1]
'127 Verify the lifecycle of daughter ref'
////*[@id="source_2728"]/td[16]/span[1]
String lifecyclestatus8 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + 
            refID_daughter1) + '"]/td[16]/span[1]']))

'128\r\n'
WebUI.verifyMatch(lifecyclestatus8, 'Artwork Upload', false)

//*[@id="source_2256"]/td[15]/span
'Verify the lifecycle of granddaughter ref'
String lifecyclestatus7 = WebUI.getText(findTestObject('1. Constant/xpath', [('xpath') : ('//*[@id="source_' + 
            refID_LI) + '"]/td[16]/span']))

WebUI.verifyMatch(lifecyclestatus7, 'Complete', false)

functions.I.Logout()

functions.I.writenotepad('D:\\Upoad_File\\Projet_ Login\\Dreyers\\13.1\\13.1_Dreyers_ProjectNo.txt', Project_No)
functions.I.writenotepad('D:\\Upoad_File\\Projet_ Login\\Dreyers\\13.1\\13.1_Dreyers_refID_Deliverable(D).txt', refID_daughter1)
functions.I.writenotepad('D:\\Upoad_File\\Projet_ Login\\Dreyers\\13.1\\13.1_Dreyers_refID_Design(M).txt',  refID)
functions.I.writenotepad('D:\\Upoad_File\\Projet_ Login\\Dreyers\\13.1\\13.1_Dreyers_refID_APL(GD).txt', refID_APL)
functions.I.writenotepad('D:\\Upoad_File\\Projet_ Login\\Dreyers\\13.1\\13.1_Dreyers_refID_LI(GD).txt', refID_LI)
