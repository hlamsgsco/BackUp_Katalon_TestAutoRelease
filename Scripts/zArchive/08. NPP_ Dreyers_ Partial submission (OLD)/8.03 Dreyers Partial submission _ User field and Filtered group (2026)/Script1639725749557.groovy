...
def project_name = (('Auto_PartialSubmission_Backup_' + org.apache.commons.lang.RandomStringUtils.randomAlphanumeric(3)) + 
...
//*[@id="source_2488"]/td[12]/span[1]
String L1 = WebUI.getText(findTestObject('xxx Todelete/xpath', [('xpath') : ('//*[@id="source_'+refID_Mother+'"]/td[12]/span[1]')]))
...
'Search Project'
functions.I.SearchProjectNo(Project_No, findTestObject('xxx Todelete/xpath', [('xpath') : ('//*[@id="form_filters"]/div[4]/button')]))
...
'Verify Lifecycle status'
//*[@id="source_2488"]/td[12]/span[1]
String L2 = WebUI.getText(findTestObject('xxx Todelete/xpath', [('xpath') : ('//*[@id="source_'+refID_Mother+'"]/td[12]/span[1]')]))
...
'Verify Lifecycle status'
//*[@id="source_2527"]/td[11]/span[1]
////*[@id="source_2708"]/td[12]/span[1]
String L3 = WebUI.getText(findTestObject('xxx Todelete/xpath', [('xpath') : ('//*[@id="source_'+refID_Mother+'"]/td[12]/span[1]')]))
