...
//STEP 1: CREATION
//PHASE 1 : LSS PREFILL
//PHASE 2 : LSS CREATION (PARTIAL SUBMISSION) 3 user fields
//Step 2 : Approval
//Step3 : Translation
//Step 5 : Effective
//Step 6 : Deactive
...
WebUI.delay(2)
String abrazhnikovapx_task_b4 = WebUI.getText(findTestObject('xxx Todelete/xpath', 
        [('xpath') : '//*[@id="kt_header"]/div/div[2]/div[1]/div[1]/span']))

functions.I.print('U1 abrazhnikovapx_task_b4 ' + abrazhnikovapx_task_b4)

double user1_b4 = Double.parseDouble(abrazhnikovapx_task_b4)
...
String alarkins_task_b4 = WebUI.getText(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="kt_header"]/div/div[2]/div[1]/div[1]/span']))
...
WebUI.delay(2)
String cdemonchy_task_b4 = WebUI.getText(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="kt_header"]/div/div[2]/div[1]/div[1]/span']))
...
WebUI.delay(2)
String afrappaz_task_b4 = WebUI.getText(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="kt_header"]/div/div[2]/div[1]/div[1]/span']))
...
functions.I.Login_password('akim', password_akim)
WebUI.delay(2)
String akim_task_b4 = WebUI.getText(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="kt_header"]/div/div[2]/div[1]/div[1]']))

functions.I.print('U5 akim_task_b4 ' + akim_task_b4)

double user5_b4 = Double.parseDouble(akim_task_b4)
...
//USER 5 ANA KIM
'User 5 - Anna kim'
String akim_task_af = WebUI.getText(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="kt_header"]/div/div[2]/div[1]/div[1]']))
...
functions.I.Login_password('abrazhnikovapx', password_abrazhnikovapx)
WebUI.delay(2)
String abrazhnikovapx_task_af = WebUI.getText(findTestObject('xxx Todelete/xpath', 
        [('xpath') : '//*[@id="kt_header"]/div/div[2]/div[1]/div[1]']))
...
functions.I.Login_password('alarkins', password_alarkins)
WebUI.delay(2)
String alarkins_task_af = WebUI.getText(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="kt_header"]/div/div[2]/div[1]/div[1]']))
...
functions.I.Login_password('cdemonchy', password_cdemonchy)
WebUI.delay(2)
String cdemonchy_task_af = WebUI.getText(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="kt_header"]/div/div[2]/div[1]/div[1]']))
...
functions.I.Login_password('afrappaz', password_afrappaz)
WebUI.delay(2)
String afrappaz_task_af = WebUI.getText(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="kt_header"]/div/div[2]/div[1]/div[1]']))
...
'Verify task has been increased by 1 for  user 5'
...
// /html/body/div[1]/div[2]/div[4]/div[3]/div/div[2]/div[2]/div[1]/table/tbody/tr[2]/td[14]/a
'Action column : Click on submit to next phase'
WebUI.click(findTestObject('xxx Todelete/xpath', [('xpath') : '/html/body/div[1]/div[2]/div[4]/div[3]/div/div[2]/div[2]/div[1]/table/tbody/tr[2]/td[14]/a']))
...
String Lifecycle_LSS_actual_user4 = WebUI.getText(findTestObject('xxx Todelete/xpath', 
        [('xpath') : '/html/body/div[1]/div[2]/div[4]/div[3]/div/div[2]/div[2]/div[1]/table/tbody/tr[2]/td[11]/span[2]']))

WebUI.verifyMatch('LSS Creation', Lifecycle_LSS_actual_user4, false)

'Verify the no. of task has decreased '
String afrappaz_task_af2 = WebUI.getText(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="kt_header"]/div/div[2]/div[1]/div[1]']))

functions.I.print('afrappaz_task_af2 ' + afrappaz_task_af2)

double user4_af2 = Double.parseDouble(afrappaz_task_af2)
...
'Go to lifecycle tab'
WebUI.click(findTestObject('xxx Todelete/xpath', [('xpath') : '/html/body/div[1]/div[2]/div[4]/div[3]/div/div[2]/div[2]/div[1]/table/tbody/tr[2]/td[7]/a']))

WebUI.delay(2)

WebUI.click(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="kt_content"]/div[3]/div/ul/li[3]/a']))

WebUI.delay(2)

'Verify the text submitted by'
String Actual_submittedby_user4 = WebUI.getText(findTestObject('xxx Todelete/xpath', 
        [('xpath') : '/html/body/div[1]/div[2]/div[8]/div[3]/div/div[3]/div[3]/div/div/div[1]/div/div[2]/div/div[2]/h5[2]']))

'194\r\n'
WebUI.verifyMatch('Submitted by', Actual_submittedby_user4, false)

'Verify the username'
String Actual_username_user4 = WebUI.getText(findTestObject('xxx Todelete/xpath', 
        [('xpath') : '/html/body/div[1]/div[2]/div[8]/div[3]/div/div[3]/div[3]/div/div/div[1]/div/div[2]/div/div[2]/div[2]/div/div/h5']))
...
//String task_user1 = WebUI.getText(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="kt_header"]/div/div[2]/div[1]/div[1]']))
'Ana Click on the lhs menu - project tab'
WebUI.click(findTestObject('1. Constant/02_LHSMenu_Projects'))
...
WebUI.click(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="fiches"]/table/tbody/tr/td[12]/a']))
...
String Lifecycle_LSS_actual_user1 = WebUI.getText(findTestObject('xxx Todelete/xpath', 
        [('xpath') : '//*[@id="fiches"]/table/tbody/tr/td[9]/span[2]']))
...
'Go to lifecycle tab'
WebUI.click(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="fiches"]/table/tbody/tr/td[5]/a']))
...
'Verify the text submitted by'
String Actual_submittedby_user1 = WebUI.getText(findTestObject('xxx Todelete/xpath', 
        [('xpath') : '/html/body/div[1]/div[2]/div[8]/div[3]/div/div[3]/div[3]/div/div/div[1]/div/div[2]/div/div[2]/h5[2]']))
...
'Verify the username'
String Actual_username_user1 = WebUI.getText(findTestObject('xxx Todelete/xpath', 
        [('xpath') : '/html/body/div[1]/div[2]/div[8]/div[3]/div/div[3]/div[3]/div/div/div[1]/div/div[2]/div/div[2]/div[2]/div[2]/div/h5']))
...
String Lifecycle_LSS_actual_user5 = WebUI.getText(findTestObject('xxx Todelete/xpath', 
        [('xpath') : '//*[@id="fiches"]/table/tbody/tr/td[7]/span[2]']))
...
WebUI.click(findTestObject('xxx Todelete/xpath', [('xpath') : '/html/body/div[1]/div[2]/div[8]/div[3]/div/div[3]/div[3]/div/ul/li[1]/a']))

'Click on expand'
WebUI.click(findTestObject('xxx Todelete/xpath', [('xpath') : '/html/body/div[1]/div[2]/div[8]/div[3]/div/div[3]/div[3]/div/div/div[1]/div/div[2]/div/div[1]/div[2]/a']))

'Verify the text submitted by'
String Actual_submittedby_user5 = WebUI.getText(findTestObject('xxx Todelete/xpath', 
        [('xpath') : '/html/body/div[1]/div[2]/div[8]/div[3]/div/div[3]/div[3]/div/div/div[1]/div/div[2]/div/div[2]/h5[2]']))
...
'Verify the username'
String Actual_username_user5 = WebUI.getText(findTestObject('xxx Todelete/xpath', 
        [('xpath') : '/html/body/div[1]/div[2]/div[8]/div[3]/div/div[3]/div[3]/div/div/div[1]/div/div[2]/div/div[2]/div[2]/div[3]/div/h5']))
...
//functions.I.writenotepad ('C:\\Users\\lamhe\\Desktop\\Upoad_File\\Projet NPP\\8.01_NPP_part1_ProjectNo.txt', Project_No)
WebUI.closeBrowser()
