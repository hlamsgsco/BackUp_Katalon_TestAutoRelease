...
////////////////////////////NAVIGATE TO NPP ///////////////////////////////////
String Project_No = functions.I.readnotepad('D:\\Upoad_File\\Projet_ Login\\NPP\\8.02\\8.02_NPP_ProjectNo.txt')

String refID = functions.I.readnotepad('D:\\Upoad_File\\Projet_ Login\\NPP\\8.02\\8.02_NPP_refID.txt')
...
'PP Approval: Submit'
WebUI.click(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="fiches"]/table/tbody/tr/td[10]/div[2]/button']))

WebUI.delay(1)

WebUI.click(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="fiches"]/table/tbody/tr/td[10]/div[2]/div/a[1]']))

WebUI.selectOptionByValue(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="var_84"]']), 
    'akim', false)
...
WebUI.selectOptionByValue(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="var_76"]']), 
    'afrappaz', false)
...
WebUI.selectOptionByValue(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="var_69"]']), 
    'ekadomtseva', false)
...
WebUI.selectOptionByValue(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="var_146"]']), 
    'sesther', false)
...
WebUI.selectOptionByValue(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="var_147"]']), 
    'mprenner', false)
...
WebUI.selectOptionByValue(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="var_56"]']), 
    'aserment', false)
...
WebUI.setText(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="var_72"]']), 
    '10/10/2030')

WebUI.setText(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="var_116"]']), 
    '10/10/2030')
...
WebUI.click(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="btnMassSubmit"]']))
 
WebUI.delay(1)

'Check ref1'
WebUI.click(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="fiches"]/table/tbody/tr/td[1]/label']))
WebUI.delay(1)
...
WebUI.takeScreenshot()
'Verify  msg'
String Amsg_1 = WebUI.getText(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="tablecontentNOK"]/table/tbody/tr/td[2]']))
...
WebUI.click(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="fiches"]/table/tbody/tr/td[10]/div[1]/button']))
 
WebUI.delay(1)
'Click on edit source text'

WebUI.click(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="fiches"]/table/tbody/tr/td[10]/div[1]/div/a[2]']))
WebUI.delay(2)

'Click on + to add translation field manually'
WebUI.click(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="aff_newfield_zone"]']))
...
WebUI.selectOptionByValue(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="type_new"]']),
	 '189', false)
WebUI.delay(2)

functions.I.Pagedown()
'Click add'
WebUI.click(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="add_newtranslationfield"]']))
 
WebUI.delay(3) 

//WebUI.scrollToElement(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="card_project"]/div[2]/div/div[3]/a[1]']), '5')
'Click save'
functions.I.click_button_javascript (findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="ModifFiche"]/div[1]/div[2]/button[1]']))
 
WebUI.delay(2)

'Click close'
functions.I.click_button_javascript (findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="ModifFiche"]/div[1]/div[2]/a']))
...
String ALM1 = WebUI.getText(findTestObject('xxx Todelete/xpath', [('xpath') : ('//*[@id="fiches"]/table/tbody/tr[1]/td[7]/span[2]')]))

WebUI.verifyMatch(ALM1, 'Waiting for translation', false)


'VErify lifecycle template - DAughter'
String ALD1 = WebUI.getText(findTestObject('xxx Todelete/xpath', [('xpath') : ('/html/body/div[1]/div[2]/div[4]/div[3]/div/div[2]/div[2]/table/tbody/tr[2]/td[7]/span[2]')]))
...
WebUI.click(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="fiches"]/table/tbody/tr[1]/td[5]/a[1]']))
...
WebUI.click(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="aff_text_content_brief"]']))
 
WebUI.delay(2)

'Verify that element is present'
String ATX1 = WebUI.getText(findTestObject('xxx Todelete/xpath', [('xpath') : ('//*[@id="my_table"]/tbody/tr/td[9]')]))
///html/body/div[1]/div[2]/div[4]/div[3]/div/div[2]/div[2]/table/tbody/tr[2]/td[7]/span[2]
