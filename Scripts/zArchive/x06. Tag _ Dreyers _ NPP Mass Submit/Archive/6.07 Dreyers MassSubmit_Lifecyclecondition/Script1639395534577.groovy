...
functions.I.click_button_javascript(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="field_var_24"]/div/div/label[2]']))

'Select APL requirement : One APL for eah Deliverable'
WebUI.selectOptionByValue(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="var_89"]']), 
    '123', false)

'Select Creative Services : Brinan Lemco'
WebUI.selectOptionByValue(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="selSource_25"]']), 
    'modonnell', false)

functions.I.select_multiplelist('//*[@id="selSource_25"]', '//*[@id="btnAdd_25"]', 'blemco')

'Brand Haagen-Dazs'
WebUI.selectOptionByValue(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="var_9"]']), 
    '18', false)
...
WebUI.setText(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="var_91"]']), 
    project_name)

'21 Separator : GPI'
WebUI.selectOptionByValue(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="var_30"]']), 
    '97', false)

'Production Agency : GRO'
WebUI.selectOptionByValue(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="var_11"]']), 
    '334', false)

'RTS – release SeparatorL 09/13/2022'
WebUI.setText(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="var_22"]']), 
    '01/01/2030')

'FTP – Files to printerL 8/25/2022'
WebUI.setText(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="var_23"]']), 
    '01/01/2030')
...
WebUI.selectOptionByValue(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="selSource_13"]']), 
    'mbaughman', false)

functions.I.select_multiplelist('//*[@id="selSource_13"]', '//*[@id="btnAdd_13"]', 'rjaiven')

'Regulatory : Ana Massoth/ Nicole Turner'
WebUI.selectOptionByValue(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="selSource_27"]']), 
    'amassoth', false)
...
WebUI.selectOptionByValue(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="selSource_166"]']), 
    'bbenjamin', false)
...
WebUI.selectOptionByValue(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="selSource_29"]']), 
    'bharandi', false)
...
WebUI.setText(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="var_name"]']), 
    ref_name)
...
WebUI.setText(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="var_137"]']), 
    'Daughter 1 MS')
...
////////////////////////////////////////////Mass Submit //////////////////////////////
//////////////////1 option only //////////////////////////
WebUI.mouseOver(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="btnMassSubmit"]/i']))

WebUI.delay(2)

String A_tooltip = WebUI.getText(findTestObject('xxx Todelete/xpath', [('xpath') : '/html/body/div[9]/div[2]']))

WebUI.verifyMatch(A_tooltip, 'Test (1option)', false)

//perform mass submit
WebUI.click(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="btnMassSubmit"]/i']))
...
'Verify  msg'
String Amsg = WebUI.getText(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="tablecontentNOK"]/table/tbody/tr']))
...
String L1 = WebUI.getText(findTestObject('xxx Todelete/xpath', [('xpath') : ('//*[@id="source_' + 
...
'Verify  msg'
String Amsg_1 = WebUI.getText(findTestObject('xxx Todelete/xpath', [('xpath') : '//*[@id="tablecontentOK"]/table/tbody/tr']))
...
////////////////////////////MOTHER REF 
////*[@id="source_2543"]/td[14]/span[1]
'Verify lifecycle status'
String ALM1 = WebUI.getText(findTestObject('xxx Todelete/xpath', [('xpath') : ('//*[@id="source_' + 
            refID_Mother) + '"]/td[14]/span[1]']))

WebUI.verifyMatch(ALM1, 'Mother Phase 2.1', false)

////////////////////////////////////////////SUBMIT Mother ref & DAughter is submitted automatically
//*[@id="source_2472"]/td[14]/span
'Verify DAughter  lifecycle status'
String ALD1 = WebUI.getText(findTestObject('xxx Todelete/xpath', [('xpath') : ('//*[@id="source_' + 
